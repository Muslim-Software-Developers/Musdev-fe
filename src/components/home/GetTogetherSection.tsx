...
const GetTogetherSection = () => {
  ...
  return (
    <section className="md:hidden bg-[#F0FFFF] text-neutral01 pb-11 pt-5 rounded-[20px] px-8 mb-[224px] mt-[118px]">
      <h2 className="text-[32px] font-bold leading-[127%] mb-2">Get together</h2>
      <p className="text-xl leading-[28px] mb-8">
        Families and friends gathered, joyous feasts shared,
        prayers offered, laughter echoed—Eid get-together, a celebration of love and togetherness
      </p>
      <div className="">
        <NextImage src={GetTogether} alt="Get Together" className='w-full -mx-3 mb-[75px]' />
      </div>
      <button className="flex lg:hidden py-2 px-4 justify-center items-center gap-2 rounded-lg text-white bg-primary mt-6">
          <span className="font-sans font-medium tracking-wider text-[14px]">Learn more</span>
          <span>
