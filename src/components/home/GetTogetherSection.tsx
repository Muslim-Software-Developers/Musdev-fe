...
// Assuming you have this asset, otherwise use the placeholder logic from before
import GetTogetherImg from "../../assets/get-togther.png";
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-32 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="relative rounded-[2.5rem] overflow-hidden bg-primary/5 border border-emerald-100 min-h-[520px] flex items-center">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 items-center w-full px-8 md:px-16 py-12">
            ...
            <div className="max-w-xl">
              <span className="reveal-item opacity-0 translate-y-10 transition-all duration-700 inline-block bg-primary/10 text-primary text-[10px] font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-lg mb-6">
                Beyond the Code
              </span>
              
              <h2 className="reveal-item opacity-0 translate-y-10 transition-all duration-700 delay-100 font-bold text-neutral01 leading-tight mb-6 text-4xl md:text-5xl lg:text-6xl">
                Community <br/> <span className="text-primary">Get Together</span>
              </h2>
              
              <p className="reveal-item opacity-0 translate-y-10 transition-all duration-700 delay-200 text-neutral02 text-lg md:text-xl leading-relaxed mb-10 font-body">
              ...
              <div className="reveal-item opacity-0 translate-y-10 transition-all duration-700 delay-300 flex flex-wrap gap-4">
                <Link
                  href="#"
                  className="inline-flex items-center gap-3 bg-primary text-white font-bold px-8 py-4 rounded-2xl hover:bg-emerald-700 transition-all duration-300 shadow-xl shadow-primary/20 group"
                >
                  Join the next one
                ...
                <div className="hidden sm:flex items-center gap-3 px-4">
                  ...
                  <span className="text-xs text-neutral02 font-semibold">500+ members joined</span>
                </div>
              </div>
            </div>
          ...
          <div className="absolute right-12 top-12 hidden lg:block reveal-item opacity-0 translate-y-10 transition-all duration-1000 delay-500">
            <div className="bg-white/80 backdrop-blur-xl border border-white p-6 rounded-3xl shadow-2xl rotate-3">
              <div className="text-primary font-bold text-2xl">100% Halal</div>
              <div className="text-neutral02 text-xs uppercase tracking-tighter">Networking & Fun</div>
            </div>
          </div>
