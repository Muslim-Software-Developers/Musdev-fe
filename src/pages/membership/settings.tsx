...
const Settings = () => {
  ...
  const displayEditForm = (text: string) => {
    if (text=== "experience") setEdit((edit:IEditObject) => ({...edit, experience: 'experience'}));
    else if (text=== "education") setEdit((edit:IEditObject) => ({...edit, education: 'education'}));
  };
  const closeEdit = (text: string) => {
    if (text=== "experience") setEdit((edit:IEditObject) => ({...edit, experience: ''}));
    else if (text=== "education") setEdit((edit:IEditObject) => ({...edit, education: ''}));
  };
  const {
    control,
    handleSubmit,
  ...
  return (
    <main className="border border-solid border-[#B6B6B6] rounded-[20px] bg-white py-8 px-16 divide-y divide-solid divide-[#B7B7B7]">
        ...
        <form className="mt-8 space-y-8">
          ...
          <div>
            <h1 className={heading}>
              Work Experience {edit.experience === "experience" && <span>Edit</span>}
            </h1>
            <div className="mt-8">
              {edit.experience !== "experience" ? (
                <WorkExperience edit={edit.experience} displayEditForm={() => displayEditForm("experience")} />
              ) : (
                <WorkExperienceEdit edit={edit.experience} closeEdit={() => closeEdit("experience")} />
              )}
            </div>
          </div>
          <div>
            ...
            <div className="mt-8">
              {edit.education !== "education" ? (
                <Education edit={edit.education} toggleEdit={() => displayEditForm("education")} />
              ) : (
                <EducationEdit edit={edit.education} closeEdit={() => closeEdit("education")} />
              )}
            </div>
          </div>
          <div>
